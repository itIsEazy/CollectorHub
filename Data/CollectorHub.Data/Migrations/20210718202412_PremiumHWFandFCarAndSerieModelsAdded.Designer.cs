...
namespace CollectorHub.Data.Migrations
{
    ...
    [Migration("20210718202412_PremiumHWFandFCarAndSerieModelsAdded")]
    partial class PremiumHWFandFCarAndSerieModelsAdded
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CollectorHub.Data.Models.LegoCollection", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CollectorHub.Data.Models.LegoCollectionLegoItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CollectorHub.Data.Models.PremiumHWCar", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CollectorHub.Data.Models.PremiumHWSerie", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CollectorHub.Data.Models.Setting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CollectorHub.Data.Models.LegoCollectionLegoItem", b =>
                {
                    b.HasOne("CollectorHub.Data.Models.LegoCollection", "Collection")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("CollectorHub.Data.Models.PremiumHWCar", b =>
                {
                    b.HasOne("CollectorHub.Data.Models.PremiumHWSerie", "Serie")
                        .WithMany("Cars")
