...
namespace CollectorHub.Data.Migrations
{
    ...
    [Migration("20210824185444_AddedCollectionIdinLegofigitm")]
    partial class AddedCollectionIdinLegofigitm
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CollectorHub.Data.Models.Collections.CollectionType", b =>
                {
            ...
            modelBuilder.Entity("CollectorHub.Data.Models.Collections.Lego.LegoType", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("CollectorHub.Data.Models.Common.Sorting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CollectorHub.Data.Models.Collections.Lego.LegoMinifigureItem", b =>
                {
                    b.HasOne("CollectorHub.Data.Models.Collections.Lego.LegoCollection", "Collection")
                        .WithMany("Items")
                        .HasForeignKey("CollectionId");
